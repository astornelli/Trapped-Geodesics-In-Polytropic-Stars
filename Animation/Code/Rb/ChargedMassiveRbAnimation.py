# Charged Massive Animation Code for Rb
import numpy as np
import matplotlib
...
def update(frame):
    ...
    plt.suptitle(
        rf"$(\rho_0 = {float(digit1):.2f} \times 10^{{{int(exponent1)}}}, p_0/\rho_0 = {p0 / rho0:.2f}, Q = 10^3, e/\mathcal{{E}} = 100, \mathcal{{E}} = 10)$",
        fontsize=12,
        y=0.9,
    )
