# Charged Massive Animation Code for Q
import numpy as np
import matplotlib
...
def update(frame):
    ...
    plt.suptitle(
        rf"$(\rho_0 = {float(digit1):.2f} \times 10^{{{int(exponent1)}}}, p_0/\rho_0 = {p0 / rho0:.2f}, r_b = 10^4, e/\mathcal{{E}} = 100, \mathcal{{E}} = 10)$",
        fontsize=12,
        y=0.9,
    )
...
ani.save("QChargedMassive.mp4", writer=writer)
